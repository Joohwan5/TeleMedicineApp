...
public class First_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        first_name_text = view.findViewById(R.id.first_name_text2);

        kidney=view.findViewById(R.id.kidney_text2);
        kidney_insert=view.findViewById(R.id.kidney_insert2);

        weight=view.findViewById(R.id.weight_text2);
        weight_insert=view.findViewById(R.id.weight_insert2);
        first_next = view.findViewById(R.id.first_button);
